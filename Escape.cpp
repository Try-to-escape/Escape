...
// Escape.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
CEscapeApp::CEscapeApp() noexcept
{
	...
	SetAppID(_T("Escape.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CEscapeApp 개체입니다.
...
BOOL CEscapeApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_EscapeTYPE,
		RUNTIME_CLASS(CEscapeDoc),
		RUNTIME_CLASS(CChildFrame), // 사용자 지정 MDI 자식 프레임입니다.
		RUNTIME_CLASS(CEscapeView));
	if (!pDocTemplate)
		return FALSE;
